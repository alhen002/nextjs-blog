    ...
    <form className="flex flex-col gap-4" action={dispatch}>
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          className="border border-neutral-400 rounded p-2 placeholder:text-sm placeholder:text-neutral-500 focus:accent-neutral-700 bg-neutral-50 dark:bg-neutral-800 transition-color duration-500"
        />
